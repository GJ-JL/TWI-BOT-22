...
user = pd.read_json('/home/gaojie/TwiBot-22-master/src/BotRGCN/twibot_22/datasets/Twibot-22/user.json')

user_text = list(user['description'])
each_user_tweets = json.load(open("processed_data/id_tweet.json", 'r'))

feature_extract = pipeline('feature-extraction', model='roberta-base', tokenizer='roberta-base', device=1, padding=True,
